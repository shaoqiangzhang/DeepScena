...
data_name = 'tasic'
data_path = './tasic2000.txt'
label_path = '../celltype.csv'
pretrain_path = '../model/%s_pretrain_param.pth'  
model_path = '../model/%s_param.pth'  
...
y = pd.read_csv(label_path, header=0,index_col=0)####大数据用这两行读取，没有行列名
y=y['true_label'].tolist()
# ######################增加下采样
