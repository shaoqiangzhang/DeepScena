...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataname", default = "pbmc4k", type = str)
    ...
    for seed in args.random_seed:
        ...
        result.append([args.dataname,kmeans_ARI,kmeans_NMI,ARI,NMI])

    output = np.array(result)
    output = pd.DataFrame(output, columns=["dataset name","kmeans ARI", "kmeans NMI","ARI", "NMI"])
    print(output)
